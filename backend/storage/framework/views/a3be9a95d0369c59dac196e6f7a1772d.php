    ...
    <form method="POST" action="<?php echo e(route('admin.announcements.update', $announcement)); ?>" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title_mk" name="title_mk"
                   value="<?php echo e(old('title_mk', $announcement->getTranslation('title', 'mk'))); ?>" required
        ...
        <div class="mb-4">
            ...
            <textarea id="content_mk" name="content_mk" rows="8" required
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500"><?php echo e(old('content_mk', $announcement->getTranslation('content', 'mk'))); ?></textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title_en" name="title_en"
                   value="<?php echo e(old('title_en', $announcement->getTranslation('title', 'en'))); ?>"
        ...
        <div class="mb-6">
            ...
            <textarea id="content_en" name="content_en" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50"><?php echo e(old('content_en', $announcement->getTranslation('content', 'en'))); ?></textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title_sq" name="title_sq"
                   value="<?php echo e(old('title_sq', $announcement->getTranslation('title', 'sq'))); ?>"
                   class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50">
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="content_sq" name="content_sq" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50"><?php echo e(old('content_sq', $announcement->getTranslation('content', 'sq'))); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <input type="number" id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $announcement->sort_order)); ?>" min="0"
                       class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
            </div>
