<?php $__env->startSection('title', 'Пофалби'); ?>
<?php $__env->startSection('page-title', 'Пофалби'); ?>
<?php $__env->startSection('page-subtitle', 'Позитивни пораки што пристигнуваат преку контакт формата'); ?>
...
<div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="w-full min-w-[900px]">
            ...
            <tbody class="divide-y divide-gray-50">
                <?php $__empty_1 = true; $__currentLoopData = $compliments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compliment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $chips = [
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors align-top">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <p class="text-[11px] text-gray-400 mt-0.5 tabular-nums"><?php echo e($compliment->created_at?->format('d.m.Y H:i')); ?></p>
                        </td>

                        
                        <td class="px-4 py-4">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($compliment->subject); ?></p>
                        </td>

                        
                        <td class="px-4 py-4">
                            <p class="text-xs text-gray-600"><?php echo e($compliment->submitted_by_email ?: '—'); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($compliment->submitted_by_phone ?: '—'); ?></p>
                        </td>

                        
                        <td class="px-4 py-4 max-w-[260px]">
                            <p class="text-xs text-gray-500 leading-relaxed"><?php echo e(\Illuminate\Support\Str::limit($compliment->message, 130)); ?></p>
                        </td>
                        ...
                        <td class="px-4 py-4">
                            <div class="flex flex-col gap-2 min-w-[140px]">
                                ...
                                <form action="<?php echo e(route('admin.compliments.update', $compliment)); ?>" method="POST" class="flex items-center gap-2">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                    <div class="relative flex-1">
                                        <select name="status"
                                            ...
                                            <option value="new"         <?php if($compliment->status === 'new'): echo 'selected'; endif; ?>>Ново</option>
                                            <option value="seen"        <?php if($compliment->status === 'seen'): echo 'selected'; endif; ?>>Прегледано</option>
                                            <option value="in_progress" <?php if($compliment->status === 'in_progress'): echo 'selected'; endif; ?>>Во работа</option>
                                            <option value="closed"      <?php if($compliment->status === 'closed'): echo 'selected'; endif; ?>>Затворено</option>
                                        </select>
    ...
    <?php if($compliments->hasPages()): ?>
        <div class="px-6 py-4 border-t border-gray-100">
            <?php echo e($compliments->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Idrizovo\backend\resources\views\admin\compliments.blade.php ENDPATH**/ ?>