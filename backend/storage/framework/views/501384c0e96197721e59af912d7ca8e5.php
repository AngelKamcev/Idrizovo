<?php $__env->startSection('title', 'Активности - Почетна'); ?>
<?php $__env->startSection('page-title', 'Активности на Почетната Страна'); ?>
<?php $__env->startSection('page-subtitle', 'Управување со активностите што се прикажуваат во слајдерот на почетната страна'); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\Idrizovo\Idrizovo\backend\resources\views/admin/index_activities.blade.php ENDPATH**/ ?>