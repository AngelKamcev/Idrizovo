...
<div class="rounded-xl border border-[#ddd9d0] bg-[#f5f3ef] overflow-hidden">
    ...
    <div class="p-6 space-y-5">
        <div>
            ...
            <input type="text" name="intro_title_mk" value="<?php echo e(old('intro_title_mk', $introTitle['mk'])); ?>"
        ...
        <div>
            ...
            <textarea name="intro_body_mk" rows="4"
                      class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30" required><?php echo e(old('intro_body_mk', $introBody['mk'])); ?></textarea>
        </div>
        <div>
            <label class="block text-xs font-medium text-[#555] mb-1.5">Цитат (Македонски)</label>
            <textarea name="quote_mk" rows="2"
                      class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30"><?php echo e(old('quote_mk', $quote['mk'])); ?></textarea>
        </div>
        <div>
            ...
            <textarea name="scroll_quotes_text_mk" rows="6"
                      class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 font-mono text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30"><?php echo e(old('scroll_quotes_text_mk', LocalizedContent::linesToText($scrollQuotes['mk']))); ?></textarea>
        </div>

        <?php echo $__env->make('admin.partials.ai-translate', [
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="intro_title_en" value="<?php echo e(old('intro_title_en', $introTitle['en'])); ?>"
            ...
            <div>
                ...
                <input type="text" name="intro_title_sq" value="<?php echo e(old('intro_title_sq', $introTitle['sq'])); ?>"
                       class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 text-sm text-[#0E1B2F]">
            </div>
            <div>
                <label class="block text-xs font-medium text-[#555] mb-1.5">Вовед (Англиски)</label>
                <textarea name="intro_body_en" rows="4"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 text-sm text-[#0E1B2F]"><?php echo e(old('intro_body_en', $introBody['en'])); ?></textarea>
            </div>
            <div>
                <label class="block text-xs font-medium text-[#555] mb-1.5">Вовед (Албански)</label>
                <textarea name="intro_body_sq" rows="4"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 text-sm text-[#0E1B2F]"><?php echo e(old('intro_body_sq', $introBody['sq'])); ?></textarea>
            </div>
            <div>
                <label class="block text-xs font-medium text-[#555] mb-1.5">Цитат (Англиски)</label>
                <textarea name="quote_en" rows="2"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 text-sm text-[#0E1B2F]"><?php echo e(old('quote_en', $quote['en'])); ?></textarea>
            </div>
            <div>
                <label class="block text-xs font-medium text-[#555] mb-1.5">Цитат (Албански)</label>
                <textarea name="quote_sq" rows="2"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 text-sm text-[#0E1B2F]"><?php echo e(old('quote_sq', $quote['sq'])); ?></textarea>
            </div>
            <div>
                ...
                <textarea name="scroll_quotes_text_en" rows="6"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 font-mono text-sm text-[#0E1B2F]"><?php echo e(old('scroll_quotes_text_en', LocalizedContent::linesToText($scrollQuotes['en']))); ?></textarea>
            </div>
            <div>
                ...
                <textarea name="scroll_quotes_text_sq" rows="6"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2.5 font-mono text-sm text-[#0E1B2F]"><?php echo e(old('scroll_quotes_text_sq', LocalizedContent::linesToText($scrollQuotes['sq']))); ?></textarea>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="rounded-xl border border-[#ddd9d0] bg-[#f5f3ef] overflow-hidden">
            ...
            <div class="p-5 space-y-5">
                ...
                <div class="space-y-2.5">
                    <input type="text" name="sections[<?php echo e($i); ?>][title_mk]"
                           value="<?php echo e(old("sections.$i.title_mk", $secTitle['mk'])); ?>"
                    ...
                    <textarea name="sections[<?php echo e($i); ?>][body_mk]" rows="4"
                              placeholder="Текст (МК)"
                              class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30" required><?php echo e(old("sections.$i.body_mk", $secBody['mk'])); ?></textarea>
                    ...
                    <div class="grid gap-2 md:grid-cols-2">
                        <input type="text" name="sections[<?php echo e($i); ?>][title_en]"
                               value="<?php echo e(old("sections.$i.title_en", $secTitle['en'])); ?>"
                               placeholder="Наслов (EN)"
                               class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm">
                        <input type="text" name="sections[<?php echo e($i); ?>][title_sq]"
                               value="<?php echo e(old("sections.$i.title_sq", $secTitle['sq'])); ?>"
                               placeholder="Наслов (SQ)"
                               class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm">
                        <textarea name="sections[<?php echo e($i); ?>][body_en]" rows="3"
                                  placeholder="Текст (EN)"
                                  class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm"><?php echo e(old("sections.$i.body_en", $secBody['en'])); ?></textarea>
                        <textarea name="sections[<?php echo e($i); ?>][body_sq]" rows="3"
                                  placeholder="Текст (SQ)"
                                  class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm"><?php echo e(old("sections.$i.body_sq", $secBody['sq'])); ?></textarea>
                    </div>
                </div>
        ...
        <div class="rounded-xl border border-[#ddd9d0] bg-[#f5f3ef] overflow-hidden">
            ...
            <div class="p-5 space-y-3">
                ...
                <input type="file" name="mobile_image_upload_<?php echo e($i); ?>" accept="image/*"
                       class="block w-full text-xs text-[#666] file:mr-2 file:rounded file:border-0 file:bg-[#0E1B2F] file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-white hover:file:bg-[#1e3251]">
                <input type="text" name="mobile_cards[<?php echo e($i); ?>][title_mk]"
                       value="<?php echo e(old("mobile_cards.$i.title_mk", $cardTitle['mk'])); ?>"
                       placeholder="Наслов (МК)"
                       class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30">
                <textarea name="mobile_cards[<?php echo e($i); ?>][body_mk]" rows="3"
                          placeholder="Текст (МК)"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-white px-3 py-2.5 text-sm text-[#0E1B2F] focus:border-[#c9a84c] focus:outline-none focus:ring-1 focus:ring-[#c9a84c]/30"><?php echo e(old("mobile_cards.$i.body_mk", $cardBody['mk'])); ?></textarea>
                ...
                <input type="text" name="mobile_cards[<?php echo e($i); ?>][title_en]"
                       value="<?php echo e(old("mobile_cards.$i.title_en", $cardTitle['en'])); ?>"
                       placeholder="Наслов (EN)"
                       class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm">
                <input type="text" name="mobile_cards[<?php echo e($i); ?>][title_sq]"
                       value="<?php echo e(old("mobile_cards.$i.title_sq", $cardTitle['sq'])); ?>"
                       placeholder="Наслов (SQ)"
                       class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm">
                <textarea name="mobile_cards[<?php echo e($i); ?>][body_en]" rows="2"
                          placeholder="Текст (EN)"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm"><?php echo e(old("mobile_cards.$i.body_en", $cardBody['en'])); ?></textarea>
                <textarea name="mobile_cards[<?php echo e($i); ?>][body_sq]" rows="2"
                          placeholder="Текст (SQ)"
                          class="w-full rounded-lg border border-[#ddd9d0] bg-gray-50 px-3 py-2 text-sm"><?php echo e(old("mobile_cards.$i.body_sq", $cardBody['sq'])); ?></textarea>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\idrizovo\Idrizovo\backend\resources\views/admin/izrabotki.blade.php ENDPATH**/ ?>