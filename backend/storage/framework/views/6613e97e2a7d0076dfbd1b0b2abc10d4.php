...
<?php if(($newComplaints ?? 0) > 0 || ($newCompliments ?? 0) > 0): ?>
    <div class="mb-8 rounded-2xl border-2 border-amber-300 bg-amber-50 p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-wrap gap-3">
            <?php if(($newComplaints ?? 0) > 0): ?>
                <a href="<?php echo e(route('admin.complaints')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-white border border-amber-200 px-4 py-2.5 text-sm font-semibold text-gray-800 hover:border-red-300">
                    Нови жалби
                    <span class="min-w-[1.5rem] h-7 px-2 rounded-full bg-red-500 text-white text-xs font-bold flex items-center justify-center"><?php echo e($newComplaints); ?></span>
                </a>
            <?php endif; ?>
            <?php if(($newCompliments ?? 0) > 0): ?>
                <a href="<?php echo e(route('admin.compliments')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-white border border-amber-200 px-4 py-2.5 text-sm font-semibold text-gray-800 hover:border-emerald-300">
                    Нови пофалби
                    <span class="min-w-[1.5rem] h-7 px-2 rounded-full bg-emerald-500 text-white text-xs font-bold flex items-center justify-center"><?php echo e($newCompliments); ?></span>
                </a>
            <?php endif; ?>
        </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Нови жалби -->
    <div class="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 <?php echo e(($newComplaints ?? 0) > 0 ? 'ring-2 ring-amber-400' : ''); ?>">
        <div class="flex items-center justify-between">
    ...
    <!-- Нови пофалби -->
    <div class="bg-white border border-gray-100 rounded-2xl p-5 flex flex-col gap-3 <?php echo e(($newCompliments ?? 0) > 0 ? 'ring-2 ring-amber-400' : ''); ?>">
        <div class="flex items-center justify-between">
