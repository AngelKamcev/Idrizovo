...
<?php $__env->startSection('title', 'Пребарај посета'); ?>
<?php $__env->startSection('page-title', 'Пребарај посета'); ?>
<?php $__env->startSection('page-subtitle', 'Внеси код и отвори ја потврдата директно како PDF'); ?>
...
<div class="vs-wrap">
  ...
  <div class="vs-card vs-card--search">
    ...
    <form id="visit-search-form" action="<?php echo e(route('admin.visit-search')); ?>" method="GET">
      <label class="vs-label" for="visit-code">Код на посета</label>
      <div class="vs-form-row">
        <input
          id="visit-code" name="code" type="text"
          value="<?php echo e(old('code', $code ?? '')); ?>"
      ...
      <?php if(session('visit_search_error') || ($searchError ?? null)): ?>
        <div class="vs-error">
          <i class="fas fa-exclamation-circle"></i>
          <?php echo e(session('visit_search_error') ?? $searchError); ?>
  ...
  <?php if(($visitRequest ?? null) && !($searchError ?? null)): ?>
    <?php
      $statusLabels = [
        'approved' => 'Одобрено',
    ...
    <div class="vs-card">
      <div class="vs-result-header">
        <div class="vs-result-meta">
          <span class="vs-code-pill">
            ...
            <?php echo e($visitRequest->confirmation->confirmation_code ?? '—'); ?>

          </span>
          <span class="<?php echo e($badgeClass); ?>">
            <i class="fas fa-check"></i>
            <?php echo e($statusLabels[$visitRequest->status] ?? ($visitRequest->status ?? '—')); ?>

          </span>
        </div>
        <div class="vs-result-actions">
          <a href="<?php echo e(route('admin.visit-search.download', ['code' => $code])); ?>" class="vs-btn vs-btn--secondary">
            <i class="fas fa-download"></i>
            Симни PDF
          </a>
          <a href="<?php echo e(route('admin.visit-search.preview', ['code' => $code])); ?>" target="_blank" class="vs-btn vs-btn--primary">
      ...
      <div class="vs-pdf-wrapper">
        <iframe
          src="<?php echo e(route('admin.visit-search.preview', ['code' => $code])); ?>"
          class="vs-pdf-frame"
          title="PDF преглед"
        ></iframe>
      </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Idrizovo\backend\resources\views/admin/visit-search.blade.php ENDPATH**/ ?>