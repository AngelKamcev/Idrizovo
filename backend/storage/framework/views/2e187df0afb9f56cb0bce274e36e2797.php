        ...
        <table class="w-full min-w-[1100px]">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" class="px-5 py-14 text-center text-sm text-gray-300">Нема пристигнати барања.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\Idrizovo\Idrizovo\backend\resources\views/admin/visit-requests.blade.php ENDPATH**/ ?>