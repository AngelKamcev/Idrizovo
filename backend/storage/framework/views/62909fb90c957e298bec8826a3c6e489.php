            ...
            <nav id="mobileMenu" class="hidden mt-5 pb-2 space-y-2">
                <?php if($canSeeDashboardAndContent): ?>
                    ...
                    <?php if($isAdmin): ?>
                        ...
                        <a href="<?php echo e(route('admin.site-logs')); ?>" class="sidebar-link <?php echo e(request()->is('admin/site-logs*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\Angel\Desktop\idrizovo\Idrizovo\backend\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>