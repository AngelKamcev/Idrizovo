...
<div class="container mx-auto px-4 py-8">
    ...
    <form method="POST" action="<?php echo e(route('admin.announcements.store')); ?>" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title_mk" name="title_mk" value="<?php echo e(old('title_mk')); ?>" required
        ...
        <div class="mb-4">
            ...
            <textarea id="content_mk" name="content_mk" rows="8" required
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500"><?php echo e(old('content_mk')); ?></textarea>
        </div>
        ...
        <div class="mb-4">
            <label for="title_en" class="block text-sm font-medium text-gray-700 mb-2">
                Наслов (Англиски)
                <span class="text-xs text-gray-400 ml-1">— пополнува се автоматски или рачно</span>
            </label>
            <input type="text" id="title_en" name="title_en" value="<?php echo e(old('title_en')); ?>"
        ...
        <div class="mb-6">
            ...
            <textarea id="content_en" name="content_en" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50"><?php echo e(old('content_en')); ?></textarea>
        </div>

        
        <div class="mb-4">
            <label for="title_sq" class="block text-sm font-medium text-gray-700 mb-2">Наслов (Албански)</label>
            <input type="text" id="title_sq" name="title_sq" value="<?php echo e(old('title_sq')); ?>"
                   class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50">
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="content_sq" name="content_sq" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50"><?php echo e(old('content_sq')); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <input type="number" id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', 0)); ?>" min="0"
                       class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\Idrizovo-dimeBackend\backend\resources\views/admin/announcements/create.blade.php ENDPATH**/ ?>