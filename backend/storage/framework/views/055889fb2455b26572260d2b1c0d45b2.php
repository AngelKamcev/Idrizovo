<?php $__env->startSection('title', 'Закажи Посета - Идризово'); ?>
...
<section id="zakazi-poseta"
  ...
  <div class="max-w-[680px] mx-auto">
    ...
    <form id="visitForm"
      method="POST"
      action="<?php echo e(route('zakazi-poseta.submit')); ?>"
        ...
        <div>
          ...
          <div id="calendarBox" class="rounded-[18px] p-5" style="background: rgba(255,255,255,0.95); border: 1px solid rgba(255,255,255,0.5);">
            ...
            <div class="grid grid-cols-7 text-center mb-2">
              <?php $__currentLoopData = ['Нед','Пон','Вто','Сре','Чет','Пет','Саб']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-[11px] font-medium text-[#6b7fa0] py-1"><?php echo e($d); ?></div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <div id="timeSlotDropdownMenu"
              class="drop-menu absolute z-30 mt-1.5 w-full rounded-[16px] bg-white overflow-hidden"
              style="border: 1px solid #dbe6f5; box-shadow: 0 8px 24px rgba(0,0,0,0.10);" role="listbox">
              <?php $__empty_1 = true; $__currentLoopData = ($visitSchedules ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <button type="button" data-value="<?php echo e($schedule->id); ?>" data-label="<?php echo e($schedule->group_name); ?> | <?php echo e($schedule->days_label); ?> | <?php echo e($schedule->time_range); ?>" class="time-slot-option w-full text-left px-4 py-3.5 text-[14px] text-[#0b1a2b] hover:bg-[#eef4fb] transition">
                  <?php echo e($schedule->group_name); ?> · <?php echo e($schedule->days_label); ?> · <?php echo e($schedule->time_range); ?>
...
<script>
  ...
  const initialBooking = <?php echo json_encode($initialBooking, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\Idrizovo\Idrizovo\backend\resources\views/zakaziposeta.blade.php ENDPATH**/ ?>