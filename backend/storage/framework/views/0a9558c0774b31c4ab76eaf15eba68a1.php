<?php $__env->startSection('title', $section['title'] . ' - Идризово'); ?>
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex items-center gap-6 mt-8 pt-6 border-t border-[#ddd9d0]">
            <div class="flex items-center gap-1.5 text-[11px] text-[#888] tracking-widest uppercase">
                ...
                <?php echo e(count($strips)); ?> <?php echo e(count($strips) === 1 ? 'слика' : 'слики'); ?>
...
<section class="bg-[#ede9e0] py-8">
    <div class="max-w-6xl mx-auto px-6">
        <img src="<?php echo e($resolveUrl($section['main_image'])); ?>"
...
<section class="bg-[#f5f3ef] py-10">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-[10px] text-[#a09a8e] tracking-wide"><?php echo e(str_pad(count($strips), 2, '0', STR_PAD_LEFT)); ?> слики</span>
            <div class="flex-1 h-px bg-[#d4cfc4]"></div>
        </div>

        
        <div class="hidden md:grid grid-cols-3 gap-1.5">
            <?php $__currentLoopData = $strips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group relative overflow-hidden bg-[#d4cfc4] <?php echo e($i === 0 ? 'col-span-2 aspect-video' : 'aspect-[4/3]'); ?>">
                <img src="<?php echo e($resolveUrl($image)); ?>"
                     alt=""
                ...
                <button type="button"
                        ...
                        data-image="<?php echo e($resolveUrl($image)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\idrizovo\Idrizovo\backend\resources\views/izrabotaki-section-detail.blade.php ENDPATH**/ ?>