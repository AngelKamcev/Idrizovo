<?php $__env->startSection('title', 'Уреди активност'); ?>
<?php $__env->startSection('page-title', 'Уреди активност'); ?>
<?php $__env->startSection('page-subtitle', 'Променете ги деталите на активноста'); ?>
...
<div class="card max-w-2xl">
    <form action="<?php echo e(route('admin.main-activities.update', $activity)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="title_mk" value="<?php echo e(old('title_mk', $activity->getTranslation('title', 'mk'))); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Напишите опис на активност" required><?php echo e(old('description_mk', $activity->getTranslation('description', 'mk'))); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Дополнителна содржина (опционално)"><?php echo e(old('content', $activity->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if($activity->getImageUrl()): ?>
            <div class="mb-6">
                ...
                <img src="<?php echo e($activity->getImageUrl()); ?>" alt="Слика" class="max-w-xs rounded-lg">
            </div>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="icon" value="<?php echo e(old('icon', $activity->icon)); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            <label class="flex items-center gap-3">
                <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $activity->is_active) ? 'checked' : ''); ?> class="rounded">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Idrizovo\backend\resources\views\admin\activities\edit.blade.php ENDPATH**/ ?>