                ...
                <?php $__empty_1 = true; $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="relative h-[210px] md:h-[205px] rounded-[16px] overflow-hidden shadow-md group">
                        ...
                        <div class="absolute bottom-0 left-0 w-full min-h-[58px] px-3 py-2 flex items-center justify-center text-white text-[14px] font-bold text-center">
                            <?php echo e($galleryImage->displayTitle()); ?>
    ...
    <div id="sektori" class="w-full bg-white px-5 md:px-6 pt-[150px] md:pt-[220px] pb-[100px] md:pb-[140px]">
        ...
        <div class="max-w-[1200px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-[95px] md:gap-y-0 md:gap-x-[120px] items-end">
                <?php $__empty_1 = true; $__currentLoopData = $homeSectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex flex-col items-center">
                        <div class="h-[165px] md:h-[190px] flex items-end justify-center mb-[-15px] relative z-10">
                            <img src="<?php echo e($resolveImageSrc($sector['img'] ?? '', 'sliki/dokumenti.png')); ?>" class="h-[155px] md:h-[180px] object-contain drop-shadow-2xl" alt="<?php echo e($sector['name'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="w-full max-w-[320px] md:w-[290px] min-h-[170px] md:min-h-[175px] bg-[#6f96d8] rounded-[18px] flex flex-col items-center justify-center text-center px-8 md:px-10 py-7">
                            ...
                            <div class="flex flex-col items-center gap-[6px] text-white text-[11px] font-bold underline leading-[16px]">
                                <?php $__currentLoopData = ($sector['sub'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Angel\Desktop\Idrizovo-dimeBackend\backend\resources\views/index.blade.php ENDPATH**/ ?>