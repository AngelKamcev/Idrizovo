                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="form-input w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-800 placeholder-gray-300 transition-all bg-gray-50 focus:bg-white {{ $errors->has('email') ? 'border-red-500' : '' }}"
                            >
                        </div>
                        @if ($errors->has('email'))
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                class="form-input w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-800 placeholder-gray-300 transition-all bg-gray-50 focus:bg-white {{ $errors->has('password') ? 'border-red-500' : '' }}"
                            >
