...
@section('page-subtitle', 'Управување со вашиот профил и кориснички пристап')
            ...
            <div class="p-6 border-b border-gray-50 bg-gray-50/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Најавени сте како: <span class="font-semibold text-blue-600">{{ $currentUser->name }}</span></p>
                    </div>
                </div>
            </div>
    ...
    <div class="xl:col-span-7">
        @if($isAdmin)
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.settings.users') }}" class="space-y-4">
                        @csrf
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach($users as $user)
                        <tr class="hover:bg-blue-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-2.5 py-1 rounded-md text-xs font-bold {{ $user->role?->name == 'admin' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' }}">
