...
<div class="container mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('admin.announcements.store') }}" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title_mk" name="title_mk" value="{{ old('title_mk') }}" required
        ...
        <div class="mb-4">
            ...
            <textarea id="content_mk" name="content_mk" rows="8" required
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">{{ old('content_mk') }}</textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="content_en" name="content_en" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50">{{ old('content_en') }}</textarea>
        </div>

        {{-- ── ALBANIAN ── --}}
        <div class="mb-4">
            <label for="title_sq" class="block text-sm font-medium text-gray-700 mb-2">Наслов (Албански)</label>
            <input type="text" id="title_sq" name="title_sq" value="{{ old('title_sq') }}"
                   class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50">
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="content_sq" name="content_sq" rows="8"
                      class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-gray-50">{{ old('content_sq') }}</textarea>
        </div>
