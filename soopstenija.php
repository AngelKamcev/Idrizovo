...
<style>
    ...
    .logo-main { display: block; width: 100%; height: auto; }
    .logo-reflection {
...
<div class="font-sans" style="background: linear-gradient(180deg, #ffffff 0%, #dce5f0 18%, #82a5d4 35%, #5982b6 100%); min-height: 100vh; color: white;">
<main>
    ...
    <div class="max-w-[1150px] mx-auto px-6 pt-10 pb-16">
        ...
        <header class="flex flex-col items-center mb-16">
            <div class="logo-wrap">
                <img src="sliki/novosti.png" alt="Новости" class="logo-main">
                <img src="sliki/novosti.png" alt="" class="logo-reflection">
            </div>
        </header>
