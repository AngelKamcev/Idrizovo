    ...
    <div id="sektori" class="section-sektori relative px-6 py-16 md:py-[100px] overflow-hidden" 
        ...
        <div class="relative z-[2] max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 md:gap-x-8">
            ...
            $sektori = array(
                ...
                array('img' => 'sliki/1.png', 'name' => 'ОДДЕЛЕНИЕ ЗА ЧОВЕЧКИ РЕСУРСИ', 'sub' => array()),
                array('img' => 'sliki/1.png', 'name' => 'ОТВОРЕНО ОДДЕЛЕНИЕ ВЕЛЕС', 'sub' => array()),
                array('img' => 'sliki/1.png', 'name' => 'СЕКТОР НА ЗАТВОРСКА ПОЛИЦИЈА', 'sub' => array()),
            );
