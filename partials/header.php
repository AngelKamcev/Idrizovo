    ...
    <nav class="bg-[#2e589e] border-b border-blue-400/30 text-white relative">
        <div class="flex justify-between items-center px-4 md:px-40 py-4">
            ...
            <ul class="hidden md:flex space-x-10 text-sm font-medium">
                <li>
                    <a href="/index.php" class="border-b-2 border-transparent hover:border-blue-300 pb-1 transition-all <?php echo (basename($_SERVER['PHP_SELF']) === 'index.php') ? 'border-blue-300' : ''; ?>">
                        Дома
                    </a>
                </li>
                <li>
                    <a href="/aboutus.php" class="border-b-2 border-transparent hover:border-blue-300 pb-1 transition-all <?php echo (basename($_SERVER['PHP_SELF']) === 'aboutus.php') ? 'border-blue-300' : ''; ?>">
                        За нас
                    </a>
                </li>
                <li class="relative group">
                    ...
                    <div class="absolute left-0 mt-2 w-48 bg-white text-black rounded-md shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                        <div class="py-2">
                            <a href="/Activities.php" class="block px-4 py-2 hover:bg-gray-100">Најнови вести</a>
                            <a href="/soopstenija.php" class="block px-4 py-2 hover:bg-gray-100">Соопштенија</a>
                            <a href="/index.php#rachni-izrabotki-galerija" class="block px-4 py-2 hover:bg-gray-100">Галерија</a>
                        </div>
                    </div>
                </li>
                <li>
                    <a href="/izrabotki.php" class="border-b-2 border-transparent hover:border-blue-300 pb-1 transition-all <?php echo (basename($_SERVER['PHP_SELF']) === 'izrabotki.php') ? 'border-blue-300' : ''; ?>">
                        Изработки
                    </a>
                </li>
                <li>
                    <a href="/Contact.php" class="border-b-2 border-transparent hover:border-blue-300 pb-1 transition-all <?php echo (basename($_SERVER['PHP_SELF']) === 'Contact.php') ? 'border-blue-300' : ''; ?>">
                        Контакт
                    </a>
                </li>
            </ul>
            ...
            <ul class="flex flex-col text-sm font-medium px-4 py-3 space-y-1">
                ...
                <li>
                    ...
                    <div id="mob-sub" class="mob-sub bg-[#1c3a6a] rounded-b-md">
                        <a href="Activities.php" class="block py-2 px-6 hover:text-blue-200 transition border-b border-blue-400/10">Најнови вести</a>
                        <a href="soopstenija.php" class="block py-2 px-6 hover:text-blue-200 transition border-b border-blue-400/10">Соопштенија</a>
                        <a href="index.php#rachni-izrabotki-galerija" class="block py-2 px-6 hover:text-blue-200 transition">Галерија</a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <a href="Contact.php" class="flex items-center py-3 px-2 border-b border-blue-400/20 hover:text-blue-200 transition">Контакт</a>
                </li>
                <li class="pt-3 pb-2">
