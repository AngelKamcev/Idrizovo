    ...
    <footer class="w-full bg-white">
        <div class="w-full bg-[#2E589E] text-white rounded-t-[40px] md:rounded-none min-h-[216px] flex flex-col md:flex-row items-center justify-between py-12 md:py-0 px-10 md:px-20 relative">
            <div class="flex-shrink-0 mb-10 md:mb-0">
                <img src="assets/images/logo.png" alt="Logo" class="h-20 mb-12 w-auto object-contain"/>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-12 lg:gap-20 w-full md:w-auto text-center md:text-left">
                ...
                <div class="flex flex-col items-center md:items-start space-y-3">
                    ...
                    <ul class="space-y-2 text-[13px] opacity-80 font-light hidden md:block">
                        <li><a href="aboutus.php#istorija" class="hover:underline">Историја</a></li>
                        <li><a href="aboutus.php#vizija" class="hover:underline">Визија</a></li>
                        <li><a href="aboutus.php#misija" class="hover:underline">Мисија</a></li>
                    </ul>
                    <div class="md:hidden flex flex-col space-y-2 text-[13px] opacity-80 font-light">
                        <a href="aboutus.php#istorija">Историја</a>
                        <a href="aboutus.php#vizija">Визија</a>
                        <a href="aboutus.php#misija">Мисија</a>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center md:items-start space-y-3">
                    ...
                    <ul class="space-y-2 text-[13px] opacity-80 font-light hidden md:block">
                        <li><a href="Activities.php" class="hover:underline">Активности</a></li>
                        <li><a href="soopstenija.php" class="hover:underline">Соопштенија</a></li>
                    </ul>
                    <div class="md:hidden flex flex-col space-y-2 text-[13px] opacity-80 font-light">
                        <a href="Activities.php">Активности</a>
                        <a href="soopstenija.php">Соопштенија</a>
                    </div>
                </div>
